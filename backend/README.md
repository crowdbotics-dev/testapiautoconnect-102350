...
## Project Structure
    ...
    ├── testapiautoconnect_102350  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_102350`
...
2. Clone this repo and `cd testapiautoconnect_102350`
